...
public class MainStackedAreaChart extends Application{
	...
	public void start(Stage primaryStage) {
		try {
			...
			StackedAreaChart<Number, Number> areaChart = new StackedAreaChart<Number, Number>(xAxis, yAxis);
			areaChart.setTitle("Entwicklung Gesamtkosten");
			xAxis.setLabel("in Jahre");
			yAxis.setLabel("in Mio. €");
			xAxis.setForceZeroInRange(true);
			
			XYChart.Series series1 = new XYChart.Series();
			series1.setName("Produkt A");
